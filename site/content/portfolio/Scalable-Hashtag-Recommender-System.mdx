...
imageUrl: "/images/portfolio/scala.png"
imageAlt: "CLI options for SHRSS tool"
tags:
  - Python
  - Scala
  - Machine Learning
...
- **Open Source Contribution:** The project is available on [GitHub](https://github.com/Rhuax/Scalable-Hashtag-Recommender-System), allowing others to contribute to and benefit from the system's development.